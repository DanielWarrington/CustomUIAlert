...
- (UIView *)createContainerView
{
    ...
    gradient.colors = [NSArray arrayWithObjects: // 201:57:49 243:72:61
                       (id)[[UIColor colorWithRed:201.0/255.0 green:57.0/255.0 blue:49.0/255.0 alpha:1.0f] CGColor],
                       (id)[[UIColor colorWithRed:243.0/255.0 green:72.0/255.0 blue:61.0/255.0 alpha:1.0f] CGColor],
                       (id)[[UIColor colorWithRed:201.0/255.0 green:57.0/255.0 blue:49.0/255.0 alpha:1.0f] CGColor],
                       nil];
    ...
    dialogContainer.layer.borderColor = [[UIColor colorWithRed:150.0/255.0 green:62.0/255.0 blue:58.0/255.0 alpha:1.0f] CGColor];
    ...
    lineView.backgroundColor = [UIColor colorWithRed:150.0/255.0 green:62.0/255.0 blue:58.0/255.0 alpha:1.0f];
    ...
    // Add the timer
    [self addTimerToView:dialogContainer];
...
- (void)addTimerToView:(UIView *)container
{
    CGFloat timerWidth = container.bounds.size.width;
    
    UIView *timerView = [[UIView alloc] initWithFrame:CGRectMake(0, container.bounds.size.height - buttonHeight, timerWidth, buttonHeight)];
    [timerView setBackgroundColor:[UIColor clearColor]];

    CGFloat timerlabelWidth = 35;
    CGFloat timerLabelHeight = timerView.bounds.size.height - 20;

    TimerView *timerLabel = [[TimerView alloc] initWithFrame:CGRectMake((timerWidth - timerlabelWidth) / 2, 10, timerlabelWidth, timerLabelHeight)];
