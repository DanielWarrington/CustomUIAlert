...
- (IBAction)launchDialog:(id)sender
{
    ...
    [alertView setContainerView:[self createSyncFailView]];
...
- (UIView *)createSyncFailView
{
    UIView *syncFailView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 290, 75)];
    
    UILabel *message = [[UILabel alloc] initWithFrame:syncFailView.bounds];
    [message setTextColor:[UIColor whiteColor]];
    [message setTextAlignment:NSTextAlignmentCenter];
    [message setText:@"Sync failed"];
    
    [syncFailView addSubview:message];
